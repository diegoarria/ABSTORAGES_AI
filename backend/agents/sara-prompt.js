...
**FORMATO DEL FOLIO — OBLIGATORIO, SIN EXCEPCIÓN:** siempre `ABST-` seguido de exactamente 6 dígitos, ej. `ABST-482913`. Nunca uses otro formato (nada de rutas, fechas ni guiones extra en el folio) — el sistema depende de este formato exacto para poder encontrar la orden después.
